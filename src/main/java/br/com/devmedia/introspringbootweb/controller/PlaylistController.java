...
import br.com.devmedia.introspringbootweb.service.PlaylistService;
...
public class PlaylistController {
    @Autowired // injetar dependencias automaticamente
    private PlaylistService playlistService;
    // controller precisa acessar playlistService para manipular playlist e ter acesso
    // as regras de negocio relacionada a essa entidade

    @GetMapping("listar")
    public ModelAndView listar(ModelMap model) {
        model.addAttribute("playlists", playlistService.recuperar());
        return new ModelAndView("/playlists/listar", model);
    }
    @GetMapping("/cadastro")
